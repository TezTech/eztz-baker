function loadNonces(){
  noncesToReveal = store.get('bknonces', []);
}
function addNonce(n){
  noncesToReveal.push(n);
  store.set('bknonces', noncesToReveal);
}
...
var store, startLevel = 0, bkint = false, injectedBlocks = [], lockbaker = false, head, pendingBlocks = [], badOps = [], endorsedBlocks = [], noncesToReveal = [], lastLevel = 0, bakedBlocks = [], logOutput = function(e){    
